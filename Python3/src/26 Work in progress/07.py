...
def p_spreadsheet(p):
    """    spreadsheet : LEFT_SQUARE_BRACKET QUOTE  headings questionBlocks QUOTE RIGHT_SQUARE_BRACKET 
    """
...
def p_questionBlock(p):
    """ questionBlock : part1 part2 part3 NL 
                 | blanks NL
    """
    print(sys._getframe().f_code.co_name)
...
s = """['Number|Section|Question|Type|Option1|Option2|Option3|Option4|Option5|Option6|Option7|Option8|Option9~||||||||||||~||||||||||||~||Highlands Client Teaming Assessment |title|"""
